...
public class RegisterForm extends JFrame {
    ...
    public RegisterForm() {
        ...
        contentPane.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{lblDangKy, tfEmail, tfMatKhau1, tfMatKhau2, cbHienThiMatKhau, btnDangKy, lblBnC, lblDangNhap}));
